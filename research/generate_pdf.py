...
|---|---|
| **Absolute / Total Net Return** | 269.5% (Total Net PNL: Rs 2,69,49,422) |
...
| **Annualized Alpha (alpha)**| 0.0% | **12.8%** |
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "Finesse x Citadel - Round 2 Submission", border=False, align="R")
        self.ln(10)
...
print("PDF created successfully via fpdf2 at IITB_Team_Report_FinesseXCitadel.pdf")
