...
| A14 | The ROE/debt quality overlay has no reported performance result until a complete, point-in-time fundamental file is available. | Research-control decision | A price-only quarterly proxy may inform implementation testing, but it is not the requested momentum-quality strategy and may not determine the final submission. |
